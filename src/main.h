...
static const uint256 hashGenesisBlock("000009c0a43a360681b13dba8ed3d2a5e96373edcad1bcc2fa0fd8ced3d127fb");
static const uint256 hashGenesisBlockTestNet("000009c0a43a360681b13dba8ed3d2a5e96373edcad1bcc2fa0fd8ced3d127fb");

static const uint256 CheckPointBlock1("00000000001c351cbbe30c60f1aaa47c6418324b66a8e82beb11c0613b108c7b"); // 1000
static const uint256 CheckPointBlock2("91f85b25cc2de2672640decd986eec727fc45366f33316a6f39ec8f6afb6d59d"); // 13010
...
public:
    ...
    {
        // burnercoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // burnercoin: get transaction coin age
...
public:
    ...
    // burnercoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // burnercoin: two types of block: proof-of-work or proof-of-stake
    ...
    // burnercoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // burnercoin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // burnercoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // burnercoin: block index flags
    enum  
    {
